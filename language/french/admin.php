...
// Admin tab menus
                ...
                'BLOCKSDSC'    => '4. Activer et paramétrer les blocs',
...
// Render defines
 	...
 	foreach ( $main_val_array as $item_lg=>$item_val ) {
                 define(strtoupper('_MD_MYHOME_'.$item_lg),$item_val);
	}
	
	
define('_MD_MYHOME_FIELD','Champ');
define('_MD_MYHOME_NULL','Null');
define('_MD_MYHOME_KEY','Clé');
define('_MD_MYHOME_DEFAULT','Defaut');
define('_MD_MYHOME_EXTRA','Extra');
define('_MD_MYHOME_N','N°');
define('_MD_MYHOME_CLOSE','Fermer');
?>
...
include('../xoops_version.php');
 	...
 	$settings_val_array =  array();
  	 ...
  	 $tips_val_array =  array(
  	                          ...
  	                          $i++        => 'Astuce : Utilisez le cache !|Surtout si vos menus ne font pas appelle à des liens dynamiques (requêtes, liens relatifs, groupes d\'accès), optimisez les temps d\'accès en activant le cache de vos blocs.',
                                  ...
                                  $i++        => 'Astuce : Auto-correction|Lorsque vous insérez une url avec le nom de domaine de votre site, myhome réécrira automatiquement l\'adresse pour en faire un lien interne.',
 	...
 	$info_val_array =  array( $i++        => 'Le saviez-vous ?|A l\'origine, myhome était une version améliorée de imenu, développé par un autre belge Linthuin.',
  	                          $i++        => 'Le saviez-vous ?|Dans sa version 1, myhome à connu plus de 9 versions successives. La dernière étant la 1.9.',
  	                          $i++        => 'Le saviez-vous ?|Pour leur majorité, les personnes qui ont contribué à la réalisation de ce modules ne sont pas des développeurs professionnel !',
                                  $i++        => 'Le saviez-vous ?|myhome a été développé avec le logiciel éditeur de texte <a href="http://www.contexteditor.org/" target="_blank">ConTEXT</a>.',
                                  $i++        => 'Le saviez-vous ?|Dans sa première version, myhome s\'écrivait "multiMenu". Le M a été réduit en minuscule pour faciliter le clonage du module. Sur la toile, cela fait toute la différence !',
                                  ...
                                  $i++        => 'Le saviez-vous ?|Les développeurs qui ont contribué à myhome n\'en ont pas touché un seul franc. C\'est ça l\'open source !',
                                  $i++        => 'Le saviez-vous ?|myhome a été développé pour Xoops 2.x uniquement. On ne retrouve aucun module similaire dans d\'autre CMS.',
                                  $i++        => 'Le saviez-vous ?|Les développeurs de myhome sont majoritairement  francophones et membres actifs de <a href="http://www.frxoops.org" target="_blank">FRXoops</a>.',
...
// Render defines
 	...
 	foreach ($item_val_array as $item_lg=>$item_val) {
                 define(strtoupper('_TI_MYHOME_'.$item_lg),$item_val);
	}
}
?>
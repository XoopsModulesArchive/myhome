...
Elles sont valables aussi bien pour les pages de contenu du module que des blocs.</i></li>
 ...
 $main_val_array['fixes_item'] =  array(
                                  ...
                                  '<{$css_link}>'      => '[MENU] Lien pointant vers le fichier CSS du menu en cours.|http:&#47;&#47;[..]/myhome_my_menu.css',
                                  '<{$script_link}>'   => '[MENU] Lien pointant vers le fichier de script .JS du menu en cours.|http:&#47;&#47;[..]/myhome_my_menu.js',
                                  ...
                                  '<{$css}>'           => '[MENU] Feuille de style du menu.|myhome_1 {color:Red;}',
                                  ...
                                  '<{$mode}>'          => 'Mode ou template de la page en cours (ou défini par défaut dans les préférences du module).|include/myhome_ul.html',
                                  '<{$module}>'        => 'Répertoire du module (ex : myhome)|myhome',

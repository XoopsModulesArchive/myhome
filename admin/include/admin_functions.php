...
if ( $option ) {
	...
	$ret .= '&nbsp;' . admin_url_selector( 0, $nav,'../item.php?id=','|', 'select', 'myhome_menu|catid|title|status');
}	
Return $ret;
}
...
function admin_footer() {
  Global $xoopsModule;
    ...
    $ret .= '<img src="../images/logo-48.png"
                  ...
                  border="0"
                  align="absmiddle" />';
    $ret .= sprintf(admin_define( 'credit' ),'Myhome', '<a href="http://www.comptoir-des-medias.com" target="_blank">Comptoir des Médias</a>' );
...
function admin_icon_legend( $width=48 ) {
 ...
 <ul style="font-style:italic;">
     <li style="display:inline;"><img src="../images/icon/on.gif" alt="on" align="absmiddle" /> '._MD_MYHOME_ONLINE.' |</li>
     <li style="display:inline;"><img src="../images/icon/hidden.gif" alt="hidden" align="absmiddle" /> '._MD_MYHOME_HIDDEN.' |</li>
     <li style="display:inline;"><img src="../images/icon/off.gif" alt="off" align="absmiddle" width="18" /> '._MD_MYHOME_OFFLINE.'</li>
     <br />
     <li style="display:inline;"><img src="../images/icon/menu.png" alt="menus" align="absmiddle" width="'.$width.'" /> '._MD_MYHOME_MENU.' |</li>
     <li style="display:inline;"><img src="../images/icon/link.png" alt="links" align="absmiddle" /> '._MD_MYHOME_LINK.' |</li>
     <li style="display:inline;"><img src="../images/icon/images.png" alt="images" align="absmiddle" /> '._MD_MYHOME_IMAGE.' |</li>
     <li style="display:inline;"><img src="../images/icon/templates.png" alt="template" align="absmiddle" width="'.$width.'" /> '._MD_MYHOME_TEMPLATE.' </li>
     <br />
     <li style="display:inline;"><img src="../images/icon/permanent.png" alt="permanent" align="absmiddle" width="'.$width.'" /> '._MD_MYHOME_PERMANENT.' |</li>
     <li style="display:inline;"><img src="../images/icon/relative.png" alt="relative" align="absmiddle" width="'.$width.'" /> '._MD_MYHOME_RELATIVE.' |</li>
     <li style="display:inline;"><img src="../images/icon/link_in.png" alt="in" align="absmiddle" width="'.$width.'" /> '._MD_MYHOME_LINKIN.' |</li>
     <li style="display:inline;"><img src="../images/icon/link_out.png" alt="out" align="absmiddle" width="'.$width.'" /> '._MD_MYHOME_LINKOUT.' |</li>
     <li style="display:inline;"><img src="../images/icon/query.png" alt="query" align="absmiddle" width="'.$width.'" /> '._MD_MYHOME_QUERY.'</li>
     <br />
     <li style="display:inline;"><img src="../images/icon/_self.png" alt="self" align="absmiddle" width="'.$width.'" /> '._MD_MYHOME_SELF.' |</li>
     <li style="display:inline;"><img src="../images/icon/_blank.png" alt="blank" align="absmiddle" width="'.$width.'" /> '._MD_MYHOME_BLANK.'</li>
     <br />
     <li style="display:inline;"><img src="../images/icon/bulle.png" alt="infobulle" align="absmiddle" width="'.$width.'" /> '._MD_MYHOME_INFOBULLE.' |</li>
     <li style="display:inline;"><img src="../images/icon/css.png" alt="css" align="absmiddle" /> '._MD_MYHOME_CSS.' |</li>
     <li style="display:inline;"><img src="../images/icon/none.png" alt="trouble" align="absmiddle" /> '._MD_MYHOME_TROUBLE.'</li>
     <br />
     <li style="display:inline;"><img src="../images/icon/edit.png" alt="edit" align="absmiddle" /> '._MD_MYHOME_EDIT.' |</li>
     <li style="display:inline;"><img src="../images/icon/clone.png" alt="clone" align="absmiddle" /> '._MD_MYHOME_CLONE.' |</li>
     <li style="display:inline;"><img src="../images/icon/delete.png" alt="delete" align="absmiddle" /> '._MD_MYHOME_DELETE.'</li>
...
function  admin_display_tip( $tip=0 ) {
  	...
  	if (file_exists('../language/' . $xoopsConfig['language'] . '/tips.php')) {
        ...
        $tip_text = constant( '_TI_MYHOME_'.$rand );

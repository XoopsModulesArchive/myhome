<?php
########################################################
#  myhome version 2.x pour Xoops 2.0.x	       #
#  						       #
...
if(!$id) {
	redirect_header('index.php', 2, _MYHOME_PL_SELECT);
	exit();
}
...
foreach($datas['result'] as $data)
        ...
        $ret .= '<div align="center">
                 ...
                 <tr class="header">
                 <th width="10%">'._MD_MYHOME_N.'</th>
                 <th width="40%">'._MD_MYHOME_IMAGE.'</th>
                 <th width="50%">'._MD_MYHOME_TITLE.'</th>
                 <th width="50%">'._MD_MYHOME_ALT_TITLE.'</th>
                 </tr>
          ';
        $ret .= $list;
        $ret .= '</div></table>';
        ...
        $ret .=  '<div align="center">
	           ...
	           <input type="button" value="'._MD_MYHOME_CLOSE.'" onclick="self.close()">
                   </form>
                   </div>
                   ';
